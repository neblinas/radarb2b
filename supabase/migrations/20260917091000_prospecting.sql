...
drop policy if exists sales_prospect_select on public.sales_prospects;
...
drop policy if exists sales_components_select on public.sales_prospect_score_components;
...
drop policy if exists public_profiles_select on public.company_public_profiles;
create policy public_profiles_select on public.company_public_profiles for select using (public.crm_has_role());
drop policy if exists public_contacts_select on public.company_public_contacts;
create policy public_contacts_select on public.company_public_contacts for select using (public.crm_has_role());
drop policy if exists public_contacts_update on public.company_public_contacts;
...
drop policy if exists public_contacts_insert on public.company_public_contacts;
...
drop policy if exists assignments_select on public.sales_assignment_history;
