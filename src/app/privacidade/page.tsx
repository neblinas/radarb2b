...
<p><strong>Responsável:</strong> {legalOperator.name}, {legalOperator.legalForm}, estabelecido em {legalOperator.country}.<br /><strong>NIF:</strong> {legalOperator.nif || "a publicar com a designação legal definitiva"}<br /><strong>Morada:</strong> {legalOperator.address || "a publicar com a designação legal definitiva"}<br /><strong>Contacto de privacidade:</strong> {legalOperator.privacyEmail || "a publicar com a designação legal definitiva"}<br /><strong>Encarregado de Proteção de Dados (DPO):</strong> {legalOperator.dpo || "não designado; contacto de privacidade indicado acima"}</p>
