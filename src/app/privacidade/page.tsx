...
export const metadata: Metadata = { title: "Política de privacidade", description: "Como o Adjudata trata dados pessoais e assegura os direitos dos titulares." };

export default function PrivacyPage() {
  return <PublicPage><article className="prose prose-invert max-w-3xl prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-white prose-p:text-slate-400 prose-li:text-slate-400"><p className="not-prose text-xs font-semibold uppercase tracking-[0.2em] text-cyan-400">RGPD</p><h1>Política de privacidade</h1><p className="lead">Última atualização: {legalOperator.lastUpdated}</p><p>Esta política explica como o Adjudata trata dados pessoais, em conformidade com o Regulamento (UE) 2016/679 (RGPD) e a legislação portuguesa aplicável.</p>
