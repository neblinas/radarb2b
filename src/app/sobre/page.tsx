...
export const metadata: Metadata = {
  title: "Sobre nós",
  description: "Conhece o Adjudata e a forma como transformamos dados públicos em inteligência comercial.",
};
...
const principles = [
  ...
  { icon: Eye, title: "Transparência", text: "Indicamos a origem BASE, as datas disponíveis e os limites dos dados. O Adjudata não promete informação em tempo real." },
];
  ...
  return (
    <PublicPage>
      <div className="max-w-3xl">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-400">Sobre o Adjudata</p>
        ...
        <p className="mt-6 text-lg leading-8 text-slate-400">O Adjudata é uma plataforma de inteligência comercial dedicada à contratação pública portuguesa. Reunimos procedimentos, contratos, entidades e empresas num espaço de pesquisa feito para equipas B2B.</p>
      </div>
