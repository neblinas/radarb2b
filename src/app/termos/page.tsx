...
<p><strong>Entidade responsável:</strong> {legalOperator.name}, {legalOperator.legalForm}, {legalOperator.country}.<br /><strong>NIF:</strong> {legalOperator.nif || "a publicar com a designação legal definitiva"}<br /><strong>Morada:</strong> {legalOperator.address || "a publicar com a designação legal definitiva"}<br /><strong>Contactos:</strong> {legalOperator.supportEmail || "email de suporte a publicar"} · {legalOperator.privacyEmail || "email de privacidade a publicar"}</p>
<p>Estas informações são disponibilizadas nos termos do artigo 10.º do Decreto-Lei n.º 7/2004, relativo ao comércio eletrónico, e demais legislação aplicável.</p>
