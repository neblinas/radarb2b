...
export const sections: Section[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "**Venda direta mensal:** vendes o plano Starter (19 €/mês) a um cliente novo. Na 1.ª mensalidade ganhas 100% de 19 € = 19 €. Na 2.ª mensalidade em diante, ganhas 10% de 19 € = 1,90 €/mês, enquanto o cliente se mantiver ativo.",
      "**Venda direta anual:** vendes o plano Pro anual (398 €/ano). Ganhas 20% de 398 € = 79,60 €.",
      ...
      "**Comissão de equipa (2.ª mensalidade):** um colaborador que geres vende o plano Starter (19 €/mês) e o cliente paga a 2.ª mensalidade — ganhas 50% de 19 € = 9,50 €.",
      "**Comissão de equipa (anual):** o mesmo colaborador vende uma subscrição anual de 398 € — ganhas 5% de 398 € = 19,90 €.",
  ...
  },
  {
    ...
    extra: {
      ...
      rows: [
        ["Free", "0 €", "50", "10", "5", "1", "—"],
        ["Starter", "19 €/mês ou 205 €/ano (poupa ~10%)", "200", "100", "25", "5", "Acesso a entidades e concorrência"],
        ["Pro", "39 €/mês ou 398 €/ano (poupa ~15%)", "Ilimitadas", "500", "100", "20", "Contexto completo de procedimentos"],
      ],
    },
    bullets: [
      "**Para uma empresa que está a começar** a explorar contratação pública, o Free já mostra valor sem risco.",
      "**Para quem participa regularmente** em concursos, o Starter é o ponto de entrada natural — desbloqueia entidades e concorrência.",
      "**Para equipas comerciais** ou empresas com participação intensa, o Pro remove os limites de pesquisa e dá o contexto completo de cada procedimento.",
